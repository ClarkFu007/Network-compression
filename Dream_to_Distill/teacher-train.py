...
parser.add_argument('--data', type=str, default='/home/yaof/apex/deep_dream/cache/data/')
parser.add_argument('--output_dir', type=str, default='/home/yaof/apex/deep_dream/cache/models/')
parser.add_argument('--teacher_name', type=str, default='Res34', help='the name of the teacher network')
...
if args.dataset == 'cifar10':
    ...
    if teacher_name == 'Res34':
        net = resnet_cifar.ResNet34().cuda()
    if teacher_name == 'WRN40-2':
        net = wresnet_cifar.WideResNet(depth=40, num_classes=10, widen_factor=2, dropRate=0.0).cuda()
    if teacher_name == 'WRN16-2':
        net = wresnet_cifar.WideResNet(depth=16, num_classes=10, widen_factor=2, dropRate=0.0).cuda()
