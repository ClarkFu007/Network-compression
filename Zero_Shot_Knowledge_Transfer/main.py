...
if __name__ == "__main__":
    ...
    parser.add_argument('--teacher_architecture', type=str, default='ResNet-34')
    parser.add_argument('--student_architecture', type=str, default='ResNet-18')
    ...
    parser.add_argument('--pretrained_models_path', nargs="?", type=str,
                        default='/home/yaof/apex/deep_dream/cache/models/teacher')
